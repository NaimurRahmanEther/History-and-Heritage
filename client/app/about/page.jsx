      ...
      <main>
        ...
        <section className="relative overflow-hidden border-b border-border py-16 lg:py-24">
          <div className="absolute inset-0 -z-10">
            <Image src="https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=1920&q=80" alt="Bangladeshi crafts" fill className="object-cover opacity-10"/>
          </div>
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="space-y-4">
                  <div className="overflow-hidden rounded-lg">
                    <Image src="/assets/monis-yousafzai-s5-q5A5PanA-unsplash.jpg" alt="Artisan weaving" width={300} height={400} className="h-64 w-full object-cover"/>
                  </div>
                  <div className="overflow-hidden rounded-lg">
                    <Image src="/assets/bamboo.jpg" alt="Traditional pottery" width={300} height={200} className="h-40 w-full object-cover"/>
                  </div>
                </div>
                <div className="space-y-4 pt-8">
                  <div className="overflow-hidden rounded-lg">
                    <Image src="/assets/katha.jpeg" alt="Bamboo weaving" width={300} height={200} className="h-40 w-full object-cover"/>
                  </div>
                  <div className="overflow-hidden rounded-lg">
                    <Image src="/assets/hh.webp" alt="Jamdani fabric" width={300} height={400} className="h-64 w-full object-cover"/>
                  </div>
                </div>
              </div>
            </div>
